public class exo13_2{
  ...
  public static void main(String[] args){
    ...
    DetecterDeadLock d = new DetecterDeadLock(TablePhilo);
  }
  ...
  public class DetecterDeadLock(){
    private Philosophe[] TablePhilo;

    DetecterDeadLock(Philosophe[] TablePhilo){
      this.TablePhilo=TablePhilo;
    }

    public void run(){
      while(true){
        boolean DeadLockD = true;
        for(int i=0;i<=4;i++){
          if(TablePhilo[i].droite.IsUsed()==false){
            DeadLockD=false;
          }
