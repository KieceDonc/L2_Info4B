...
public class exo18_4{
  static Semaphore semaTC = new Semaphore(2);
  ...
  public void run(){
    ...
    while(j<600){
      if(tCourant.nom.equals("t1") ||tCourant.nom.equals("t3")){
        ...
        // on rend le jeton
        try{
          exo18_4.semaTC.release();
        }catch(Exception e){
          e.printStackTrace();
        }
        // si tous les jetons sont disponible, on met le sens de parcours
        if(exo18_4.semaTC.availablePermits()==2){
